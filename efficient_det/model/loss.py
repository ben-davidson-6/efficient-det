...
class EfficientDetLoss(tf.keras.losses.Loss):
    ...
    def call(self, y_true, y_pred, sample_weight=None):
        ...
        positive_mask, training_mask, num_positive, num_training_per_image = EfficientDetLoss._calculate_mask_and_normaliser(y_true_class)
        ...
        fl = fl * self.weights[0] * training_mask / num_training_per_image
    ...
    def _calculate_mask_and_normaliser(y_true_class):
        ...
        num_training_per_image = tf.maximum(tf.reduce_sum(
            training_mask, [1, 2, 3], keepdims=True), 1.)    
        return positive_mask, training_mask, num_positive_per_image, num_training_per_image
